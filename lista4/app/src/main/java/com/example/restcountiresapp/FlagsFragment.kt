...
class FlagsFragment : Fragment() {
    ...
    private val viewModel: FlagsViewModel by viewModels()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView = view.findViewById<RecyclerView>(R.id.flagsRecyclerView)
    ...
    fun onDataUpdated(items: List<RecyclerViewItems>) {
        recyclerView.adapter = FlagsRecyclerViewAdapter(items)
